...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between text-sm mb-5'>
      ...
      {/* Right Side (Profile / Register Button / Menu Icon) */}
      <div className='flex items-center gap-4'>
        {token && userData ? (
          <div className='flex items-center gap-2 cursor-pointer group relative'>
            {/* User Image (Safe Check) */}
            {userData.image ? (
              <img
          ...
          <button
            ...
            className='bg-neutral-500 text-white px-8 py-3 rounded-full font-light hidden md:block'
          >
            Register
          </button>
        )}
